...
public class STCMMenuTypes {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<EnhancedForgeHammerMenu>> ENHANCED_FORGE_HAMMER_MENU =
            registerMenuType("enhanced_forge_hammer_menu", EnhancedForgeHammerMenu::new);
